...
class DataGetter
{
    ...
    {
        /**
         * 'orderId' field is unique ID generated by Payu.pl after request is sent
         * 'extOrderId' theoretically could be Magento order ID but because we can have multiple attempts for payment,
         *  we need to send more specific ID
         */
